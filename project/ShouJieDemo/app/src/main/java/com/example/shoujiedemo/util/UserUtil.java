...
public class UserUtil {
    ...
    public static int USER_ID = 2;                      //用户ID
    public static String USER_NAME = "用户名";           //用户名
    public static String USER_SEX = "无";               //用户性别
    public static int USER_AGE = 0;                     //用户年龄
    public static String USER_SIGN = "";                //用户个性签名
    public static String USER_IMG = "";                 //用户头像
    public static String USER_CENTER_BACKGROUND = "";   //用户个人中心背景图
    public static String USER_SPACE_BACKGROUND = "";    //用户我的空间背景图
