...
public class RegisterModelImpl implements RegisterModel{
    ...
    @Override
    public void register(String name, String password, final RegisterPresenterListener listener) {
        ...
        Observable<ResponseBody> observable = apiInterface.register(name,password);
                ...
                .subscribe(new Observer<ResponseBody>() {
                    ...
                    public void onNext(ResponseBody responseBody) {
                        if (responseBody!=null){
                            try {
                                String state = responseBody.string();
                                switch (state) {
                                    case "ERROR":
