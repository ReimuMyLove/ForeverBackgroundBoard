...
public class AriticleUploadActivity extends AppCompatActivity implements LoadView {
    ...
    private void initData() {
        imageView = findViewById(R.id.upload_article_cover);
        radio1 = findViewById(R.id.isOriginal);
        main_text = findViewById(R.id.ed_article_content);
        writer = findViewById(R.id.upload_ed_article_writer);
    ...
    class MyOnclickLisenter implements View.OnClickListener {
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                case R.id.upload_btn_article_commit:
                    CommitPoem();
                    break;
