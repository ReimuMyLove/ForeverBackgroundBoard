...
public class MyCommentModelImpl implements MyCommentModel {
    private static final String BASE_URL = "http://49.232.217.140:8080/OuranServices/cheat/";
    @Override
    public void getCommentList(int userId, final MyCommentPresenterListener listener) {
        ...
        Observable<ResponseBody> observable = apiInterface.getCommentList(userId);
                    ...
                    public void onNext(ResponseBody responseBody) {
                        try {
                            ...
                            if (jsons.equals("false")){
                                listener.getCommentListFailed();
                            }else {
                                listener.getCommentListSuccessful(jsons);
                            }
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
