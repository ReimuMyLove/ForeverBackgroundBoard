...
public class MusicLoadDataModelImpl implements FroundHotDataModel{
    @Override
    public void loadContents(final HotLoadDataPresenterListener listener, int page, int userId) {
        ...
        Observable<ResponseBody> observable = apiInterface.loadMusic(page,userId);
    ...
    @Override
    public void search(HotLoadDataPresenterListener listener, String flag, int page, int userId) {
