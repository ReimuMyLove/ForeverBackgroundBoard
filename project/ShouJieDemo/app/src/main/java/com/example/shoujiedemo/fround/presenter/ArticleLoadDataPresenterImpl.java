...
import com.example.shoujiedemo.fround.model.ArticleLoadDataModelImpl;
...
public class ArticleLoadDataPresenterImpl implements FroundLoadDataPresenter,FroundLoadDataPresenterLisenter{
    private FroundLoadDataModel model;
    private ArticleView view;

    public ArticleLoadDataPresenterImpl(ArticleView view) {
        this.view = view;
        model = new ArticleLoadDataModelImpl();
    }
