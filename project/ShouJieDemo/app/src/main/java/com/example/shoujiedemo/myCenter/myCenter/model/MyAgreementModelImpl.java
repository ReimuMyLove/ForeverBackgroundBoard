...
public class MyAgreementModelImpl implements MyAgreementModel{
    private static final String BASE_URL = "http://49.232.217.140:8080/OuranServices/likes/";
    @Override
    public void getAgreementList(int userID, final MyAgreementPresenterListener listener) {
        ...
        Observable<ResponseBody> observable = apiInterface.getAgreementList(userID);
                    ...
                    public void onNext(ResponseBody responseBody) {
                        try {
                            ...
                            if (jsons.equals("false")){
                                listener.getAgreementListFailed();
                            }else {
                                listener.getAgreementListSuccessful(jsons);
                            }
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
