...
public class PoemLoadDataModelImpl implements FroundLoadDataModel{


    @Override
    public void loadContents(final FroundLoadDataPresenterLisenter listener, int typeId, int page) {
        ...
        Observable<ResponseBody> observable = apiInterface.loadContent(typeId,page);
