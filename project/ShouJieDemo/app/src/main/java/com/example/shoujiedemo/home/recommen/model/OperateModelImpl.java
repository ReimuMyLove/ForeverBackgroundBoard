...
public class OperateModelImpl implements OperateModel{
    ...
    @Override
    public void loadContent(final OpreatePresenterListener listener) {
        ...
        Observable<ResponseBody> observable = apiInterface.loadRecomment();
                ...
                .subscribe(new Observer<ResponseBody>() {
                    ...
                    public void onNext(ResponseBody responseBody) {
                        try {
                            ...
                            if(jsons != null)
                                listener.loadContentSuccess(jsons);
                            else
                                listener.loadContentError();
