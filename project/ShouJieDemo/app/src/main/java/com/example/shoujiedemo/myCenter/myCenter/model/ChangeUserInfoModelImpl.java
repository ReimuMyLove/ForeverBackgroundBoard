...
public class ChangeUserInfoModelImpl implements ChangeUserInfoModel {
    private static final String BASE_URL = "http://49.232.217.140:8080/OuranServices/user/";
    @Override
    public void changeInfo(int userID, int userAge, String userSex, String userSign, final UserInfoPresenterListener listener) {
        ...
        Observable<ResponseBody> observable = apiInterface.changeInfo(userID,userAge,userSign,userSex);
                    ...
                    public void onNext(ResponseBody responseBody) {
                        try {
                            ...
                            if (jsons.equals("false")){
                                listener.changeInfoFailed();
                            }else {
                                listener.changeInfoSuccessful();
                            }
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
